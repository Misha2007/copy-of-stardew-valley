...
class SoilLayer:
    ...
    def fishing(self, item_inventory):
        # file1 = open("fish.txt", "w")
        fishes = random.randint(0, 3)
        # print(fishes)
        item_inventory['fish'] += fishes